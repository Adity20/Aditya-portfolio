...
import IIIT_KOTA from "../assets/logo-1.webp";
import AOS from "aos";
      ...
      <div className="WRAPPER mt-10">
        ...
        >
          <div className="max-w-[520px] mt-[52px] p-7 max-sm:p-3">
            <div className="flex gap-5 w-190">
              <img
                src={IIIT_KOTA}
                alt="Bennett University Logo"
                className="w-[90px] h-[90px]"
              />
              <h1 className="bg-clip-text text-transparent bg-gradient-to-r max-sm:text-[17px] mt-6 from-amber-500 via-orange-600 to-yellow-500 dark:from-[#ff6600] dark:to-slate-100 font-semibold text-2xl w-[300px] h-[100px] tracking-wider ">
                Bennett University
              </h1>
            </div>
